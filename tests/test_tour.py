"""pt_tour.py ist eine wortgleiche Kopie des Hill-Climbing-Kerns der hill-climbing-demo (über sa_tour.py aus der
...
Schranke, CP-SAT), damit sich alle weiteren Stücke dieses Repos (Metropolis, Tausch, PT-Schleife) auf einen
geprüften Kern verlassen können - dieselbe Prüfung wie in hill-climbing-demo/tests und simulated-annealing-demo/tests."""
